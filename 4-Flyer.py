...
l1=tk.Label(root,text="Bookingid")
l1.grid(row=0)
t1=tk.Entry(root)
t1.grid(row=0,column=1)
l2=tk.Label(root,text="Passenger Name:")
l2.grid(row=1)
t2=tk.Entry(root)
t2.grid(row=1,column=1)
v = StringVar(root, value='6E512')
l3=tk.Label(root,text="Flight")
l3.grid(row=2)
t3=tk.Entry(root,textvariable=v)
t3.grid(row=2,column=1)
l4=tk.Label(root,text="Source")
l4.grid(row=3)
radio1=IntVar()
radio2=IntVar()
rb1=Radiobutton(root,text='Delhi',variable=radio1,command=f)
rb1.grid(row=3,column=1)
rb2=Radiobutton(root,text='Mumbai',variable=radio2,command=f)
rb2.grid(row=3,column=2)
l41=tk.Label(root,text="Destination")
l41.grid(row=3,column=3)
radio3=IntVar()
radio4=IntVar()
rb3=Radiobutton(root,text='Dehradun',variable=radio3,command=f1)
rb3.grid(row=3,column=4)
rb4=Radiobutton(root,text='Kolkata',variable=radio4,command=f1)
rb4.grid(row=3,column=5)
l5=tk.Label(root,text="Duration")
l5.grid(row=4)
spin = Spinbox(root,from_=3,to=24)
