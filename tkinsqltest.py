...
def disp():
    ...
    with conn:
        ...
        r_set = cursor.execute('''SELECT * from Student ''');
...
list1 = ['India', 'Philippines', 'Japan', 'Korea', 'China', 'Singapore', 'Hong kong'];
...
Button(root, text="Delete Record", width=20, bg='lightblue', fg='red', command=dele).place(x=250, y=380)
Button(root, text="Display Records", width=20, bg='lightblue', fg='red', command=disp).place(x=400, y=380)
root.mainloop()